...
folder = "home/pza/enf_demo/input/pwr_fls"
...
for file in onlyfiles:
   ...
   # pdb.set_trace()
    ...
    temp = power_signal_object.compute_ENF_from_combined_strip(power_OurStripCell, power_initial_frequency)
    power_ENFs.append(temp)


plt.figure()
#pdb.set_trace()
for i in range(len(onlyfiles)):
    plt.plot(power_ENFs[i][:-10], label=onlyfiles[i])
